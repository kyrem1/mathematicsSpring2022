...
\begin{homeworkProblem}
  \textbf{(i)} Suppose that $X$ is a set. Let $J$ be a contable set and suppose that $X=\bigsqcup_{j\in J} A_j$ with $A_j \neq \emptyset$ for all $j\in J$. Show that the $\sigma$-algebra generated by $(A_j)_{j\in J}$ is $\{\bigcup_{j\in J_0} : J_0\sub J\}$.
