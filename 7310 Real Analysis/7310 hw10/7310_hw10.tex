...
\begin{homeworkProblem}
  ...
  \begin{proof}
    ...
    \end{align*}
    Now suppose that $E$ is Borel and let $(a_j,b_j]$ be a countable sequence of $h$-intervals such that $E\sub \bigcup_{j=1}^\infty (a_j,b_j]$. Then
    \[
      \lrvert{\sum_{j=1}^{\infty}\mu_F((a_j,b_j])}\leq \sum_{j=1}^{\infty}|\mu_F((a_j,b_j])| \leq \sum_{j=1}^{\infty}\mu_{T_F}((a_j,b_j]),
    \]
    whence $|\mu_F(E)|\leq \sum_{j=1}^{\infty}\mu_{T_F}((a_j,b_j])$. As $E\sub \bigcup_{j=1}^\infty (a_j,b_j]$ was arbitrary, after taking an infimum it follows by outer regularity of $\mu_{T_F}$ that $|\mu_F(E)|\leq \mu_{T_F}(E)$. 
  \end{proof}
